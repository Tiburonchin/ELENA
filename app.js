document.addEventListener('DOMContentLoaded', () => {
    ...
    function positionStickers(stickerSelectors) {
        ...
        stickerSelectors.forEach((sel, index) => {
            ...
            if (isMobile) {
                ...
                // Escritorio: volver a la caja principal y dejar que CSS decida
                appContainer.appendChild(el);
                gsap.set(el, { clearProps: "left,top,right,bottom,position,maxWidth,maxHeight" });
            }
        });
    }
    ...
    btnNext1.addEventListener('click', () => {
        // Al ir al Paso 2
        alert('CABE RECALCAR QUE se puede cambiar los planes para ir a otros sitios como (playa, museo, jironear o mimir {es bueno para la salud} jsjs).');
